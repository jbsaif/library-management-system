...
import java.time.temporal.ChronoUnit; // NEW IMPORT for date difference calculation
import java.math.BigDecimal; // NEW IMPORT for fine currency
...
public class BorrowServiceImpl implements BorrowService {
    ...
    private static final int LOAN_PERIOD_DAYS = 14; // Books are due in 14 days
    private static final BigDecimal FINE_RATE_PER_DAY = new BigDecimal("0.50"); // $0.50 per day overdue
    ...
    public BorrowRecord borrowBook(Long bookId, String username) {
        ...
        record.setDueDate(dueDate);  // Set the calculated due date
    ...
    public List<BorrowRecord> findBorrowedBooksByUser(String username) {
        ...
        // Uses the custom repository method to find active loans (findByUserIdAndReturnDateIsNull)
    ...
    public void returnBook(Long recordId) {
        ...
        // 1. Get the BorrowRecord (and fail if not found)
